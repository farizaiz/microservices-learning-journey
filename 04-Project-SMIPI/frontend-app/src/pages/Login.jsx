      ...
      <div style={{ 
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginBottom: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', textAlign: 'left' }}>
            ...
            <p style={{ margin: '4px 0 0 0', color: '#ffc107', fontSize: '16px', fontWeight: 'bold', letterSpacing: '0.8px' }}>
              SISTEM MANAJEMEN INFORMASI<br/>PELAPORAN INVESTIGASI
            </p>
          </div>
        </div>

        <h2 style={{ margin: '0 0 25px', color: '#333', fontSize: '20px', fontWeight: 'bold', textAlign: 'center', letterSpacing: '1px' }}>
          PORTAL LOGIN
        </h2>
