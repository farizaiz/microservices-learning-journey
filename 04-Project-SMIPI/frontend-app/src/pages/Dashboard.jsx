...
function Dashboard() {
  ...
  // State Form & Modal Edit/Create KASUS
    ...
    <div style={{ padding: '30px', maxWidth: '1400px', margin: '0 auto', display: 'flex', flexDirection: 'column', gap: '25px' }}>
      ...
      <div style={{ backgroundColor: '#ffffff', padding: '25px', borderRadius: '12px', boxShadow: '0 4px 15px rgba(0,0,0,0.05)' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
          <h3 style={{ margin: 0, color: '#333', fontSize: '18px' }}>Sistem Manajemen Informasi Pelaporan Investigasi</h3>
      ...
      {/* MODAL FORM CREATE/EDIT KASUS (TETAP SAMA) */}
      {isModalOpen && (
      ...
      {/* MODAL VIEW DETAIL INVESTIGASI (TETAP SAMA) */}
      {viewDetail && (
